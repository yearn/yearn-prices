 ...
 * balance.
 */
export function yip88LiquidLockerAdapter(options: OnchainAdapterOptions): PlannedPriceAdapter {
  return plannedAdapter('yip88-liquid-locker-redemption', async (target) => {
    if (target.chainId !== 1) {
      return null
    }
